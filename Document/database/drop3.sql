...
ALTER TABLE `survey_reponse` DROP FOREIGN KEY `survey_survey_reponse`;

ALTER TABLE `survey_reponse` DROP FOREIGN KEY `question_survey_reponse`;

# ---------------------------------------------------------------------- #
# Drop table "survey_reponse"                                            #
# ---------------------------------------------------------------------- #

# Drop constraints #

ALTER TABLE `survey_reponse` DROP PRIMARY KEY;
