...
class textClass extends question{
	...
	Public function layout($field, $xml=false){
			...
			$caption = ((empty($field['question_options']->caption)))? '': $field['question_options']->caption ;$caption = $field['question_options']->caption;
			...
			if($xml){
				...
				<question>
					...
					<class>".$field['question_type']."</class>
					<input>
						<id type=\"text\">q".$field['question_id']."</id>
		 		...
		 		$ret = '<li id="qid_'.$field['question_id'].'" class="'.$field['question_type'].'">
                    <div class="question-label">'.$field['question_label'].'</div>
                       ...
                       <div class="question-block" style="'.$text.'">
                            <input type="text" id="q'.$field['question_id'].'" name="q'.$field['question_id'].'" value="" style="'.$width.'z-index:100;'.$height.'"/>
